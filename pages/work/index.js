      ...
      <MaxWidthWrapper>
        <GridWrapper>
          <Intro>
            ...
            <Callout>
              <p>
                Charlsy is actively looking for full-time product
                design roles. Learn more about{' '}
          ...
          <Experience>
            ...
            <Table>
              <tbody>
                {' '}
                {/* Added to avoid hydration failed error (caused by Next.js) */}
                <TableRow>
                  <TdYear>NOW</TdYear>
                  <TdCompany>Microsoft</TdCompany>
                  <TdRole>Product Designer</TdRole>
                </TableRow>
                <TableRow>
                  <TdYear>2022</TdYear>
