...
[^2]: *Designerly Way of Knowing* by Nigel Cross
[^3]: *What is a Designer* by Norman Potter
[^4]: No, I don’t think accessibility alone determines what is a good design.
[^5]: *Notes on the Synthesis of Form* by Christopher Alexander
[^6]: *Design Methods* by John C. Jones
[^7]: *Sketching User Experience* by Bill Buxton
[^8]: *Design-Oriented Human-Computer Interaction* by Daniel Fällman
[^9]: *The Sciences of the Artificial* by Herbert Simon. “The natural sciences are concerned with how things are. … Design, on the other hand, is concerned with how things ought to be, with devising artifacts to attain goals.”