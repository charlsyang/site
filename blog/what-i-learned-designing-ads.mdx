...
As to why Mrwhosetheboss saw what he saw, first, it shouldn’t be too surprising that ads appear to be more relevant than organic results because ads are more personalized and targeted with the data they leverage (controversial, I know). Second, it could be regional market differences that some richer organic features or data weren’t available in where he was. Finally, it could simply be that those features weren’t triggered because of how dynamic search results are. Of course, users are the ultimate arbitrator of the quality of experience, I am just trying to give some plausible reasons on why things were the way they were.
