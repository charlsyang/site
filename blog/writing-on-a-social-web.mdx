...
Robin mentions [blot.im](blot.im), and I absolutely *love* it. I used it for a while for [my Chinese blog](https://charlsy.me) before Alex kindly helped me move it to host on Vercel<SideNote>Even using a static site generator like Eleventy was way too technical for me.</SideNote>. Blot makes a website out of a folder. Publishing a post is as simple as moving a file from one folder to another. This is what writing on the web should feel like: easy, fast, and accessible.
