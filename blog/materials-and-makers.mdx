...
Mariel Cooper was such a designer and educator who always sought to build responsive tools and systems and demolish the boundary between design and production. In the seventies, she offered [a studio class](https://messageandsmeans.tumblr.com/) at MIT that later became the Visible Language Workshop, a constellation of courses that centered around hands-on production. In describing the purpose of VLW, Cooper lists: 
...
The owner of a site creates and curates her content, devises her layouts, and codes them all together by herself. She builds her place from the ground up and shapes it however she wants. Through an alchemy of whims and hard work she brings to life her representation on the internet, a corner devoted to her quirkiness and a refuge housing thoughts however weird and odd. A personal website is one’s individuality manifested to its fullest, a love letter to the world wide web as well as to the spirit of the maker. 
