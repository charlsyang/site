...
So how to bridge the gap between design and production? Well, there’re multiple ways to approach this, like Dan’s [Play](https://www.createwithplay.com/). But I’d like to approach it from the perspective of [the wholeness of work](/blog/the-wholeness-of-work)—which leads to a natural answer that the designer should assume the role of a maker and reject the pigeonholing by an industry that rewards only specialization. 
