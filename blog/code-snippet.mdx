...
Some long overdue love for my blog—added support for code snippets and syntax highlight (with `prism-react-renderer`). So here’s a few random codes just to test out how it looks. Properly themed and type set in [Input Mono](https://input.djr.com/) by David Jonathan Ross.
