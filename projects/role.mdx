...
<MediaRow content= {[
    {type: 'image', source: '/project_role/p2-s1-before.png', caption: 'Before'},
    {type: 'image', source: '/project_role/p2-s1-after.png', caption: 'After'}
]} single='true'/>
...
<MediaStack>
<MediaRow content= {[
    {type: 'image', source: '/project_role/p2-s2-before.png', caption: 'Before'},
    {type: 'image', source: '/project_role/p2-s2-after.png', caption: 'After'}
]}/>
<MediaRow content= {[
    {type: 'image', source: '/project_role/p2-s2-details.png', caption: '“View Details” opens a side tray that shows more granular information.'}
]} bg='true'/>
</MediaStack>
...
<MediaRow content= {[
    {type: 'image', source: '/project_role/p2-s3-clear.png', caption: 'Hide “Clear Configuration” by default'},
    {type: 'image', source: '/project_role/p2-s3-modal.png', caption: 'Confirmation modal'}
]} single='true' bg='true'/>

## Problem III
### Previous research revealed that users consistently ignored the chip rows in the table 
...
<MediaRow content= {[
    {type: 'image', source: '/project_role/p3-s1-before.png', caption: 'Before: chip row'},
    {type: 'image', source: '/project_role/p3-s1-after.png', caption: 'After: expanded row'}
]} single='true'/>

#### Solution 2: Breaking the flow into 2 steps—one thing at a time

Another cause of the issue, I figured, was intermingling the selection of data sources and the editing of permissions into one step. It was therefore unclear what users need to do, when the modal title says “selecting objects” but editing permissions is also included. As a result, I decided to break the flow into two steps with one thing at a time. 

<MediaStack>

<MediaRow content= {[
    {type: 'image', source: '/project_role/p3-s2-before.png', caption: 'Before: selecting data source and editing permission in one step'},
    {type: 'image', source: '/project_role/p3-s2-after.png', caption: 'After: separate editing permission into another step'}
]}/>
<MediaRow content= {[
    {type: 'image', source: '/project_role/p3-s2-step1.png', caption: 'Step 1: select objects'},
    {type: 'image', source: '/project_role/p3-s2-step2.png', caption: 'Step 2: configure permissions'}
]} bg='true'/>
...
My designer brain that loves logical coherence realized that it might not always be a good thing. 

<Contact>Interested in the process and what I learned from the evaluation? Hit me up for a deep dive of the project.</Contact>